...
간단한 Streamlit UI에서 PDF를 업로드하고 테이블 내용 조건을 입력하면, `opendataloader-pdf` 파서가 추출한 테이블 중 조건에 맞는 항목을 HTML 또는 Markdown 형식으로 확인하고 내보내는 예제 앱입니다.
...
2. 테이블 내용 조건을 입력합니다. 조건을 비워두면 모든 테이블을 가져옵니다.
